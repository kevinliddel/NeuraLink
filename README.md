...
<table>
  ...
  <tr>
    ...
    <td><strong>Neural Lip-Sync</strong><br/>Real-time audio amplitude analysis mapped to VRM blend shapes. See <a href="./docs/LipSync.md">Lip-Sync Documentation</a> and <a href="./docs/openai_realtime_ga_migration.md">Realtime Audio Documentation</a></td>
  </tr>
  <tr>
