...
We as members, contributors, and maintainers of **NeuraLink** pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socioeconomic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all community spaces — including the GitHub repository, Issues, Pull Requests, Discussions, and any other official project channel — and also applies when an individual is officially representing the project in public spaces (e.g., posting via an official social media account or acting as an appointed representative at an event).

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by opening a **private security advisory** on GitHub or by contacting the maintainers directly via the contact information listed in the repository profile.
